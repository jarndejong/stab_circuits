...
stab1 = np.array([[0,0,0,0],[1,1,1,0]]);
stab2 = np.array([[0,1,1,1],[0,0,0,0]]);
stab3 = np.array([[1,1,0,1],[1,1,0,1]]);


gen_list = (stab1,stab2,stab3);
...
print(stab.logical_pauli(gen_matrix))
